...
@Component({
  selector: 'app-cache-poison-resource',
  template: `
    <section class="card">
      <h2>resource() → single HttpTransferCache poison</h2>
      <p>The attacker controls a CMS slug plus legitimate dynamic setting names and JSON values. The settings map is stored under <code>__proto__</code>.</p>
...
export class CachePoisonResourceComponent {
